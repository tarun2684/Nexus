...
async def get_user_history(
    ...
    daily_log_stmt = (
        select(DailyLog)
        .where(DailyLog.user_id == dev_user_id, DailyLog.date >= start_date, DailyLog.date <= today)
    ...
    return HistoryOut(user_id=dev_user_id, days=history_entries, total_xp_in_period=total_xp)
