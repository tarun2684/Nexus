...
class StreakManager:
    ...
    def calculate_streak(
        self, completion_dates: list[datetime], reference_date: datetime | None = None
    ) -> StreakInfo:
        """
        ...
        normalized_dates = sorted(
            set(self.normalize_date(d) for d in completion_dates), reverse=True
        )
    ...
    def is_daily_quest_due(
        self, last_completion: datetime | None, reference_date: datetime | None = None
    ) -> bool:
        """
